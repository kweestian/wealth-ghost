	...
	$(document).ready(function() {
		...
		$(function(){
			$(window).resize(function(){
				...
				$('.slider-area .item').css('height',windowy + 'px');
			}).resize();    
		});
		$('.carousel').carousel();
		...
		function init_map() {
			...
			var infowindow = new google.maps.InfoWindow({
				content: "<b>Gloria Theme</b><br/>King Street, 98321<br/> New York"  //add your address
			});
		...
		function loading() {
			$('.result-newsletter').show().html('Loading...');
		}
		...
		if(fbroot == "") {
			...
			(function(d, s, id) {
				...
				js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6&appId=244189802594837";
